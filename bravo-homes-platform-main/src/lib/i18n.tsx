...
const T: Translations = {
  ...
  clientNameCol: { 'pt-BR': 'NOME', 'en-US': 'NAME', es: 'NOMBRE' },
  emailCol: { 'pt-BR': 'EMAIL', 'en-US': 'EMAIL', es: 'EMAIL' },
  phoneCol: { 'pt-BR': 'TELEFONE', 'en-US': 'PHONE', es: 'TELÉFONO' },
  addressCityCol: { 'pt-BR': 'ENDEREÇO / CIDADE', 'en-US': 'ADDRESS / CITY', es: 'DIRECCIÓN / CIUDAD' },
  createdCol: { 'pt-BR': 'CRIADO', 'en-US': 'CREATED', es: 'CREADO' },
  actionsCol: { 'pt-BR': 'AÇÕES', 'en-US': 'ACTIONS', es: 'ACCIONES' },
  noClients: { 'pt-BR': 'Nenhum cliente encontrado.', 'en-US': 'No clients found.', es: 'No se encontraron clientes.' },
  historyTooltip: { 'pt-BR': 'Histórico em breve!', 'en-US': 'History coming soon!', es: '¡Historial próximamente!' },
  deleteClientTitle: { 'pt-BR': 'Excluir cliente', 'en-US': 'Delete client', es: 'Eliminar cliente' },
  ...
  actionLabel: { 'pt-BR': 'AÇÃO', 'en-US': 'ACTION', es: 'ACCIÓN' },
  editBtn: { 'pt-BR': 'Editar', 'en-US': 'Edit', es: 'Editar' },
  deleteProjectConfirm: { 'pt-BR': 'Deseja excluir o projeto', 'en-US': 'Do you want to delete project', es: '¿Desea eliminar el proyecto' },
  projectDeletedSuccess: { 'pt-BR': 'Projeto excluído com sucesso!', 'en-US': 'Project deleted successfully!', es: '¡Proyecto eliminado exitosamente!' },
  loadingProjects: { 'pt-BR': 'Carregando projetos...', 'en-US': 'Loading projects...', es: 'Cargando proyectos...' },
  projectPlaceholder: { 'pt-BR': 'Projeto sem nome', 'en-US': 'Unnamed Project', es: 'Proyecto sin nombre' },
  statusNd: { 'pt-BR': 'N/D', 'en-US': 'N/A', es: 'N/D' },
  ...
  // ─── PARTNER PROFILE ───
  myPartnerProfile: { 'pt-BR': 'Meu Perfil de Parceiro', 'en-US': 'My Partner Profile', es: 'Mi Perfil de Socio' },
  personalInfo: { 'pt-BR': 'Informações Pessoais', 'en-US': 'Personal Information', es: 'Información Personal' },
  savingProfile: { 'pt-BR': 'Salvando...', 'en-US': 'Saving...', es: 'Guardando...' },
  specialtyMulti: { 'pt-BR': 'Especialidade (Múltiplas)', 'en-US': 'Specialty (Select multiple)', es: 'Especialidad (Múltiple)' },
  addSpecialty: { 'pt-BR': '-- Adicionar Especialidade --', 'en-US': '-- Add Specialty --', es: '-- Añadir Especialidad --' },
  licenseNumber: { 'pt-BR': 'Número da Licença', 'en-US': 'License Number', es: 'Número de Licencia' },
  city: { 'pt-BR': 'Cidade', 'en-US': 'City', es: 'Ciudad' },
  state: { 'pt-BR': 'Estado', 'en-US': 'State', es: 'Estado' },
  bioAbout: { 'pt-BR': 'Bio / Sobre', 'en-US': 'Bio / About', es: 'Biografía / Acerca de' },
  bioPlaceholder: { 'pt-BR': 'Conte aos clientes sobre sua experiência...', 'en-US': 'Tell clients about your experience...', es: 'Cuéntales a los clientes...' },
  notListed: { 'pt-BR': 'Não listado', 'en-US': 'Not listed', es: 'No listado' },
  notSet: { 'pt-BR': 'Não definido', 'en-US': 'Not set', es: 'No definido' },
  location: { 'pt-BR': 'Localização', 'en-US': 'Location', es: 'Ubicación' },
  notifPrefs: { 'pt-BR': '🔔 Preferências de Notificação', 'en-US': '🔔 Notification Preferences', es: '🔔 Preferencias de Notificación' },
  emailNotif: { 'pt-BR': 'Notificações por Email', 'en-US': 'Email Notifications', es: 'Notificaciones por Email' },
  emailNotifDesc: { 'pt-BR': 'Novos leads, projetos, mensagens', 'en-US': 'New leads, project updates, messages', es: 'Nuevos leads, proyectos, mensajes' },
  smsNotif: { 'pt-BR': 'Notificações por SMS', 'en-US': 'SMS Notifications', es: 'Notificaciones por SMS' },
  smsNotifDesc: { 'pt-BR': 'Atualizações urgentes e alertas', 'en-US': 'Urgent updates and lead alerts', es: 'Actualizaciones urgentes y alertas' },
  newPassPlaceholder: { 'pt-BR': 'Nova senha (mín 6 carac)', 'en-US': 'New password (min 6 chars)', es: 'Nueva contraseña (mín 6 cars)' },
  confirmNewPass: { 'pt-BR': 'Confirmar nova senha', 'en-US': 'Confirm new password', es: 'Confirmar nueva contraseña' },
  changingPass: { 'pt-BR': 'Alterando...', 'en-US': 'Changing...', es: 'Cambiando...' },
  updatePassBtn: { 'pt-BR': '🔒 Atualizar Senha', 'en-US': '🔒 Update Password', es: '🔒 Actualizar Contraseña' },

  // ─── PARTNER UPLOADS ───
  selectProject: { 'pt-BR': '📁 Selecionar Projeto', 'en-US': '📁 Select Project', es: '📁 Seleccionar Proyecto' },
  selectStage: { 'pt-BR': '📂 Selecionar Etapa', 'en-US': '📂 Select Stage', es: '📂 Seleccionar Etapa' },
  chooseStageToAttach: { 'pt-BR': 'Escolha em qual etapa deseja anexar os arquivos:', 'en-US': 'Choose which stage to attach files to:', es: 'Elige a qué etapa adjuntar los archivos:' },
  generalFiles: { 'pt-BR': 'Arquivos Gerais', 'en-US': 'General Files', es: 'Archivos Generales' },
  noLinkedStage: { 'pt-BR': 'Sem etapa vinculada', 'en-US': 'No linked stage', es: 'Sin etapa vinculada' },
  stagePrefix: { 'pt-BR': 'Etapa', 'en-US': 'Stage', es: 'Etapa' },
  completedStage: { 'pt-BR': '✅ Concluída', 'en-US': '✅ Completed', es: '✅ Completada' },
  inProgressStage: { 'pt-BR': '🔄 Em andamento', 'en-US': '🔄 In progress', es: '🔄 En progreso' },
  pendingStage: { 'pt-BR': '⏳ Pendente', 'en-US': '⏳ Pending', es: '⏳ Pendiente' },
  sendPhotosDocs: { 'pt-BR': '📸 Enviar Fotos / Documentos', 'en-US': '📸 Send Photos / Docs', es: '📸 Enviar Fotos / Docs' },
  sendingFiles: { 'pt-BR': 'Enviando arquivos...', 'en-US': 'Uploading files...', es: 'Subiendo archivos...' },
  clickDragPhotos: { 'pt-BR': 'Clique ou arraste fotos/documentos aqui', 'en-US': 'Click or drag photos/docs here', es: 'Haz clic o arrastra fotos/docs aquí' },
  popupWillAppear: { 'pt-BR': 'Um popup aparecerá para você selecionar a etapa de destino.', 'en-US': 'A popup will appear for you to select the target stage.', es: 'Aparecerá una ventana emergente para seleccionar la etapa.' },
  noPhotosDocsStage: { 'pt-BR': 'Sem foto/docs disponíveis para esta etapa.', 'en-US': 'No photos/docs available for this stage.', es: 'Sin fotos/docs disponibles para esta etapa.' },
  generalNoStage: { 'pt-BR': 'Geral (Sem Etapa)', 'en-US': 'General (No Stage)', es: 'General (Sin Etapa)' },
  generalProjectDocs: { 'pt-BR': 'Documentos Gerais do Projeto', 'en-US': 'General Project Documents', es: 'Documentos Generales del Proyecto' },
  attachedFiles: { 'pt-BR': 'arquivos anexados', 'en-US': 'files attached', es: 'archivos adjuntos' },
  viewBtn: { 'pt-BR': 'Ver', 'en-US': 'View', es: 'Ver' },
  files: { 'pt-BR': 'arquivos', 'en-US': 'files', es: 'archivos' },
  selectProjectToManageFiles: { 'pt-BR': 'Selecione um projeto acima para gerenciar fotos e documentos', 'en-US': 'Select a project above to manage photos and documents', es: 'Seleccione un proyecto arriba para administrar fotos y documentos' },
